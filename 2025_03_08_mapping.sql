...
VALUES
    ...
    ('Distance', 'Sonic Distance', 'Distance', 'dragino', 'dds45', 'millimeters', 'int(value) if isinstance(value, int) else int(value.split()[0])', 'Sonic Distance from sensor', TRUE, 120);
